...
class Student(models.Model):
    ...
    exam = models.ManyToManyField(Exam, null=True, blank=True)

    def __str__(self):
        return self.class_name+" "+self.student_id
...
class ExamPaper(models.Model):
    ...
    choice_questions = models.CharField("选择题列表", max_length=200,  default='')
    choice_question_answers = models.CharField("选择题答案列表", max_length=200,  default='')

    completion_questions = models.CharField("填空题列表", max_length=200,  default='')
    completion_question_answers = models.CharField("填空题答案列表", max_length=200,  default='')

    coding_questions = models.CharField("编程题列表", max_length=200,  default='')
    coding_question_answers = models.CharField("编程题答案列表", max_length=200, default='')
